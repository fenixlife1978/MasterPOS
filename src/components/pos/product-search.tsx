                  ...
                  >
                    ...
                    <div className="flex-1 min-w-0">
                      ...
                      <div className="flex items-center gap-4 mt-1">
                        ...
                        <span className="bg-[#00FF00] text-black px-2 py-0.5 rounded text-[10px] font-black uppercase tracking-tighter border border-green-800 shadow-sm">
                          STOCK: {p.stock}
                        </span>
                      </div>
                    </div>
            ...
            {clientResults.map(c => (
              ...
              >
                ...
                <div className="flex-1">
                  ...
                  {c.debt > 0 ? (
                    <div className="mt-2">
                      <span className="bg-[#FF0000] text-black px-2 py-0.5 rounded text-[10px] font-black uppercase border border-red-800">
                        DEUDA: BS {c.debt.toFixed(2)}
                      </span>
                    </div>
                  ) : (
                    <div className="mt-2">
                      <span className="bg-[#00FF00] text-black px-2 py-0.5 rounded text-[10px] font-black uppercase border border-green-800">
                        AL DÍA
                      </span>
                    </div>
                  )}

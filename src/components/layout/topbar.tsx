...
export default function Topbar({ register, rate, onRateChange }: TopbarProps) {
  ...
  return (
    <header className="h-[56px] bg-secondary border-b border-white/10 flex items-center px-6 gap-6 shrink-0 z-40 text-white">
      ...
      <div className="ml-auto flex items-center gap-6">
        <div className="bg-white/10 px-5 py-1.5 rounded-full flex items-center gap-3 border border-white/20">
          ...
          <div className="flex items-center gap-2 text-[13px]">
            ...
            <input 
              ...
              className="w-12 bg-transparent border-none text-white font-black focus:outline-none text-center text-[15px]"
            />
            <span className="text-white/50 text-[10px] font-bold ml-1">BS/USD</span>
          </div>
        </div>

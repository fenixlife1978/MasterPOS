                    ...
                    <div key={payment.id} className="border border-gray-200 rounded-lg p-3 hover:bg-slate-50">
                      <div className="flex justify-between items-start">
                        <div>
                          ...
                          {relatedInvoice && <p className="text-[8px] text-black/40">Factura #{relatedInvoice.invoiceNumber || relatedInvoice.id}</p>}
                        </div>
                                      ...
                                      return (
                                        ...
                                        >
                                          <div className="flex justify-between items-start">
                                            ...
                                            >
                                              <p className="font-medium text-sm">Factura #{inv.invoiceNumber || inv.id}</p>
